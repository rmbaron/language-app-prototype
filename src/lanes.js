...
export const LANES = [
  { id: 'reading',   label: 'Reading',   modality: 'receptive',  medium: 'text'  },
  { id: 'writing',   label: 'Writing',   modality: 'productive', medium: 'text'  },
  { id: 'listening', label: 'Listening', modality: 'receptive',  medium: 'audio' },
  { id: 'speaking',  label: 'Speaking',  modality: 'productive', medium: 'audio' },
]

// LANE_DISPLAY — UI-only properties.
// Swap initials for icon nodes, recolor, etc. without touching functional code.
